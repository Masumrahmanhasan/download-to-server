                      ...
                      <div class="mb-3">
                          ...
                          <div class="d-flex">
                              <div class="d-flex items-center me-4">
                                  <input id="inline-checkbox" type="checkbox" name="download_type" value="latest" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                  <label for="inline-checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Latest</label>
                              </div>
                              <div class="d-flex items-center me-4">
                                  <input id="inline-2-checkbox" type="checkbox" name="download_type" value="all" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
